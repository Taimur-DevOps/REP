          ...
          variant === "primary"
            ? `${
                disabled
                  ...
                  : `text-center text-base text-white bg-lightPeach rounded-[4px] font-nokara .nokora-regular py-2 px-9 ${className}`
              }`
            : variant === "secondary"
            ? `${
                disabled
                  ? `cursor-not-allowed rounded-lg border border-gray-300 bg-gray-200 px-4 py-2 text-sm font-medium text-gray-500 shadow-sm `
                  : `bg-secondary   cursor-pointer rounded-lg from-slate-700 via-slate-800 to-slate-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gradient-to-t ${className}`
              }`
            : variant === "tertiary"
            ? `${
                disabled
                  ...
                  : ` rounded-lg border border-Gray px-4 py-2 text-sm font-semibold text-Gray hover:bg-btnBg lg:text-base ${className}`
              }`
            : variant === "advanced"
            ? `${
                disabled
