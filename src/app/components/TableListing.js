                ...
                <tbody>
                    <tr class="odd:bg-white  even:bg-gray-50 text-gray-900  ">
                        ...
                        <td class="px-6 py-4 flex justify-start items-center gap-2 ">
                            <span><LiaEditSolid className="h-5 w-5 text-blue-500  hover:cursor-pointer" /></span>
                            <span><RiDeleteBin7Line className='h-5 w-5 text-red-500  hover:cursor-pointer' /></span>
                        </td>
                    </tr>
                    <tr class="odd:bg-white  even:bg-gray-50 text-gray-900  ">
                        <th scope="row" class="px-6 py-4 font-medium whitespace-nowrap">
