          ...
          <div className="">
            <div className="row">
              <div className="col-lg-12">
                ...
                {/* <h2 className="page-description"> Let's connect and make it happen!</h2> */}
              </div>
            </div>
          </div>
        </div>

        <main className=" text-gray-100 px-8 py-4 ">
          <div
            ...
            <div className="">
              <div>
                ...
                <input className="w-full bg-[FFF9F5] text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
              ...
              <div className="mt-2">
                ...
                <textarea
                  className="w-full h-32 bg-[FFF9F5] text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
              </div>
              <div className="mt-2">
                <button
                  className="uppercase text-sm font-bold tracking-wide bg-[#253156] text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                  Send Message
                </button>
              </div>
            </div>
